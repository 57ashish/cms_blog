 ...
 <?php
    ...
    if(isset($_POST['create_post']))
    {
        ...
        $query="insert into posts values (0,'{$post_tags}',0,'{$post_status}',{$post_category_id},'{$post_title}','{$post_author}',now(),'{$post_image}','{$post_content}')";//now() is a funtion for date
   ...
   ?>
	...
	<div class="form-group">
		<button class="btn btn-primary" name="create_post" >Publish Post</button>
	</div>
